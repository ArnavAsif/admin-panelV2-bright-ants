...
const Testimonial = () => {
    ...
    const resetForm = () => {
        setForm({ id: null, name: '', designation: '', company: '', image: null, content: '' });
        setIsEditing(false);
    };
    ...
    if (!isEditing && testimonials.length >= 3) {
        return Swal.fire("Limit Reached", "You can only add up to 3 testimonials.", "warning");
    }
    ...
    try {
        ...
        const endpoint = isEditing ? `${API}/testimonials/${form.id}` : `${API}/testimonials`;
        ...
        Swal.fire("Success", isEditing ? "Updated successfully" : "Added successfully", "success");
        resetForm();
        fetchTestimonials();
    } catch (err) {
    ...
    return (
        <div className="p-6 max-w-4xl mx-auto">
            ...
            <div className="grid gap-6">
                {testimonials.map((t) => (
                    <div key={t.id} className="bg-white shadow rounded p-4 flex gap-4 items-start">
                        <img
                        ...
                        <div className="flex flex-col gap-2">
                            <button onClick={() => handleEdit(t)} className="btn btn-sm btn-info">Edit</button>
